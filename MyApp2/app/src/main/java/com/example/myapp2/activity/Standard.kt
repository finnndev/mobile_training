...
class Standard : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        buttonStandard.setOnClickListener {
            startActivity(Intent(this@Standard, Standard::class.java))
        }
        text.text = "ID: ${this.hashCode()}"
        buttonSingleTop.setOnClickListener {
            startActivity(Intent(this@Standard, SingleTop::class.java))
        }
        buttonSingleTask.setOnClickListener {
            startActivity(Intent(this@Standard, SingleTask::class.java))
        }
        buttonSingleInstance.setOnClickListener {
            startActivity(Intent(this@Standard, SingleInstance::class.java))
        }
    }
