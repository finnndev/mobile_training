...
class _EditScheduleDialogState extends State<EditScheduleDialog> {
  ...
  void _initFields() {
    ...
    time = kTimeSlots.contains(widget.model.time) ? widget.model.time : kTimeSlots.first;
    stylist = kCreators.any((s) => s.name == widget.model.stylist)
        ? widget.model.stylist
        : kCreators.first.name;
    selectedServices = widget.model.service
        .split(', ')
  ...
  Widget _buildServiceCheckbox(String label) {
    final isChecked = selectedServices.contains(label);
    return CheckboxListTile(
      ...
      title: Text(label, style: const TextStyle(color: ColorsConstants.text)),
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: const BorderSide(color: ColorsConstants.yellowPrimary, width: 1),
      ),
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...kServices.map((s) => _buildServiceCheckbox(s.label)),
                ],
              ),
            ),
            const SizedBox(height: 8),
        ...
        ElevatedButton(
          ...
          onPressed: () {
            widget.onSave(ScheduleModel(
              ...
              date: date,
              stylist: stylist,
              service: selectedServices.toList().join(', '),
