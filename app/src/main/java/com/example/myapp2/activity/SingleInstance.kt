...
class SingleInstance : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        buttonStandard.setOnClickListener {
            startActivity(Intent(this@SingleInstance, Standard::class.java))
        }
        text.text = "ID: ${this.hashCode()}"
        buttonSingleTop.setOnClickListener {
            startActivity(Intent(this@SingleInstance, SingleTop::class.java))
        }
        buttonSingleTask.setOnClickListener {
            startActivity(Intent(this@SingleInstance, SingleTask::class.java))
        }
        buttonSingleInstance.setOnClickListener {
            startActivity(Intent(this@SingleInstance, SingleInstance::class.java))
        }
    }
