...
class SingleTop : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        buttonStandard.setOnClickListener {
            startActivity(Intent(this@SingleTop, Standard::class.java))
        }
        text.text = "ID: ${this.hashCode()}"
        buttonSingleTop.setOnClickListener {
            startActivity(Intent(this@SingleTop, SingleTop::class.java))
        }
        buttonSingleTask.setOnClickListener {
            startActivity(Intent(this@SingleTop, SingleTask::class.java))
        }
        buttonSingleInstance.setOnClickListener {
            startActivity(Intent(this@SingleTop, SingleInstance::class.java))
        }
    }
